...
# and drones. Default values for NS and ND need to be provided as input.
...
write('blocks.txt, ident.txt, steer.txt and pedigree.txt are input for AMD-AINV.r',file="log_pedigree.txt",append=TRUE)
if(msinglesires==1){
...
write.table(steer,file="steer.txt",row.names=FALSE,col.names=FALSE)
